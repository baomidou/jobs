...
public class JobsTriggerPool {
    ...
    private ThreadPoolExecutor fastTriggerPool = new ThreadPoolExecutor(
            ...
            new ThreadFactory() {
                ...
                public Thread newThread(Runnable r) {
                    return new Thread(r, "jobs, admin JobsTriggerPool-fastTriggerPool-" + r.hashCode());
                }
            });
    ...
    private ThreadPoolExecutor slowTriggerPool = new ThreadPoolExecutor(
            ...
            new ThreadFactory() {
                @Override
                public Thread newThread(Runnable r) {
                    return new Thread(r, "jobs, admin JobsTriggerPool-slowTriggerPool-" + r.hashCode());
                }
            });
    ...
    public void addTrigger(final int jobId, final TriggerTypeEnum triggerType, final int failRetryCount, final String executorShardingParam, final String executorParam) {
        ...
        triggerPool_.execute(new Runnable() {
            ...
            public void run() {
                ...
                try {
                    // do trigger
                    JobsTrigger.trigger(jobId, triggerType, failRetryCount, executorShardingParam, executorParam);
                } catch (Exception e) {
    ...
    public void stop() {
        ...
        log.info(">>>>>>>>> jobs trigger monitor pool shutdown success.");
    }

    // ---------------------- helper ----------------------

    private static JobsTriggerPool JOB_TRIGGER_POOL = new JobsTriggerPool();
