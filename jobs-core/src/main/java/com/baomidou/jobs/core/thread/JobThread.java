...
public class JobThread extends Thread{
	...
	public void run() {
		...
		while(!toStop){
            ...
            try {
				...
				if (triggerParam!=null) {
					...
					// execute
					XxlJobLogger.log("<br>----------- jobs job execute start -----------<br>----------- Param:" + triggerParam.getExecutorParams());
					...
					if (triggerParam.getExecutorTimeout() > 0) {
						...
						try {
							...
							XxlJobLogger.log("<br>----------- jobs job execute timeout");
							XxlJobLogger.log(e);
					...
					XxlJobLogger.log("<br>----------- jobs job execute end(finish) -----------<br>----------- ReturnT:" + executeResult);
				...
				XxlJobLogger.log("<br>----------- JobThread Exception:" + errorMsg + "<br>----------- jobs job execute end(error) -----------");
			} finally {
                if(triggerParam != null) {
		...
		logger.info(">>>>>>>>>>> jobs JobThread stoped, hashCode:{}", Thread.currentThread());
	}
}
